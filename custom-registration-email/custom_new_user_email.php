...
/*
Plugin Name: Custom New User Email Escuela de Triunfadoras
...
function wp_new_user_notification( $user_id, $deprecated = null, $notify = '' ) {
	...
	$message .= __('<p> Puedes volver a cambiar tu contraseña, aquí:</p>') . "\r\n\r\n";
	$message .= '<' . network_site_url("wp-login.php?action=rp&key=$key&login=" . rawurlencode($user->user_login), 'login') . ">\r\n\r\n";
	$message .= __('<p>Lo dicho, bienvenida.</p>');
	$message .= __('<p>Es un verdadero placer tenerte en el programa.<p></br></p>');
	$message .= __('<p>Cariños,</p>');
	$message .= __('<p>Adela Pereira</p>');

	wp_mail($user->user_email, sprintf(__('Bienvenida a Cariño, tú vales mucho [%s]'), $blogname), $message);
